...
[![Support Level](https://img.shields.io/badge/support-active-green.svg)](#support-level) [![Release Version](https://img.shields.io/github/release/BushwackStudio/action-wordpress-plugin-deploy.svg)](https://github.com/BushwackStudio/action-wordpress-plugin-deploy/releases/latest) [![MIT License](https://img.shields.io/github/license/BushwackStudio/action-wordpress-plugin-deploy.svg)](https://github.com/BushwackStudio/action-wordpress-plugin-deploy/blob/develop/LICENSE) [![Automated Tests](https://github.com/BushwackStudio/action-wordpress-plugin-deploy/actions/workflows/test.yml/badge.svg)](https://github.com/BushwackStudio/action-wordpress-plugin-deploy/actions/workflows/test.yml)
...
* `USER_EMAIL` - The user email in git config.
* `USER_NAME` - The user name in git config.
...
This is a fork of 10up's repository with the same name. We are greatful for their work.
